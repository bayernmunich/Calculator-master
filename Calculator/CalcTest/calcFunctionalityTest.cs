...
namespace CalcTest
{
    ...
    public class calcFunctionalityTest
    {
        ...
        ///A test for fnAdd
        ///</summary>
        //[DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", "C:/Users/tfsadmin/Desktop/Calculator-master/Calculator/CalcTest/data.csv", "data#csv", DataAccessMethod.Sequential), DeploymentItem("CalcTest\\data.csv"), TestMethod()]
        public void fnAddTest()
        {
            calcFunctionality target = new calcFunctionality(); // TODO: Initialize to an appropriate value
            double num1 = 2; // TODO: Initialize to an appropriate value
            double num2 = 2; // TODO: Initialize to an appropriate value
